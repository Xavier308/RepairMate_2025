...
import { 
  fetchMachineDetails, deleteMachine, getMachineImages, submitTroubleshootingRequest,
  getMachineManual, copyMachineTemplate
} from '@/services/api';

import {
  FaBookmark, FaLock, FaCog, FaMagic, FaTrash, FaBook, FaPencilAlt, FaPlus,
  FaExclamationCircle, FaFilePdf, FaDownload, FaEllipsisV, FaCopy
} from 'react-icons/fa';
