...
import { fetchManufacturers, fetchCategories, fetchDepartments, fetchMachineTypes, createMachine, uploadMachineImage } from '../services/api';
import CustomizationWizard from './CustomizationWizard.jsx';
